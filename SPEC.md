...
src/
  ...
  graph/            Graph subsystem: Graph[] construction/validation, queries
                    ...
                    (Adjacency/Incidence), generators (Complete/Cycle/Path/
                    Random), search (shortest path, components, spanning tree,
                    connectivity), and GraphPlot (one builtin per file, mirrors
                    linalg/)
